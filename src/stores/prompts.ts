...
export const usePromptStore = defineStore('prompts', () => {
  ...
  const optimizablePrompts = computed(() => [
    ...
    { key: 'SKELETON_VALIDATOR' as const, name: 'Skeleton Validator', description: 'Validates placeholders against canon' },
    { key: 'CHAPTER_SUMMARIZER' as const, name: 'Chapter Summarizer', description: 'Compresses chapters for rolling context' },
    { key: 'CHAPTER_WRITER_HIERARCHICAL' as const, name: 'Hierarchical Chapter Writer', description: 'Expands validated placeholders using rolling context' },
    { key: 'ROLLING_CONTEXT_EDIT' as const, name: 'Rolling Context Editor', description: 'Edits with bible + previous summary context' },
